        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div id="notifications-menu" class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
              @foreach($notifications->getNotifications() as $notification)
                <a class="dropdown-item" href="#">{{ trans('admin.' . $notification->notification) }}
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="{{ url('mall-manager/language/en') }}">English</a>
              <a class="dropdown-item" href="{{ url('mall-manager/language/ar') }}">عربي</a>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('mall-manager/logout') }}">
              {{ trans('admin.logout') }}
            </a>
          </li>
        </ul>
