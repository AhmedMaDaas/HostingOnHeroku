...
@section('content')
    ...
    <div class="table">
      <h3 class="box-title" style="margin-left: 10px">{{ trans('admin.trade_mark_control') }}</h3>
      {{ Form::open(['id' => 'data_form', 'url' => url('/mall-manager/trademarks/destroy/all'), 'method' => 'delete']) }}
      {{ $dataTable->table([
