        ...
        <div class="card card-default" data-scroll-height="675">
          ...
          <div class="card-footer d-flex flex-wrap bg-white p-0">
            <div class="col-6">
              <div class="py-4 px-4">
                <ul class="d-flex flex-column justify-content-between">
                  <li class="mb-2"><span class="jam jam-pie-chart-alt" style='color:#4c84ff;margin-right:5px'></span>{{ trans('admin.completed_orders') }}</li>
                </ul>
              </div>
            </div>
            <div class="col-6 border-left">
              <div class="py-4 px-4 ">
                <ul class="d-flex flex-column justify-content-between">
                  <li class="mb-2"><span class="jam jam-pie-chart-alt" style='color:#fec402;margin-right:5px'></span>{{ trans('admin.pending_orders') }}</li>
                  <li><span class="jam jam-pie-chart-alt" style='color:#fe5461;margin-right:5px'></span>{{ trans('admin.cancelled_orders') }}</li>
                </ul>
              </div>
            </div>
          </div>
