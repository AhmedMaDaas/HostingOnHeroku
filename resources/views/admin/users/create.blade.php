        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">{{ trans('admin.new_user') }}</h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <!--<label class="bmd-label-floating">User Level </label>-->
                        ...
                        {{ Form::select('level', ['user' => trans('admin.user'), 'mall' => trans('admin.mall_manager'), 'company' => trans('admin.company')], old('level'), ['class' => 'form-control', 'placeholder' => trans('admin.level')]) }}
                    </div>
