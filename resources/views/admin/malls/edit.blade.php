...
<?php
  $lng = !empty($mall->lng) ? $mall->lng : 33.49924510522839;
  $lat = !empty($mall->lat) ? $mall->lat : 36.288330078125;
?>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            {{ Form::open(['url' => url('/admin/malls/' . $mall->id), 'files' => true, 'method' => 'put']) }}
              <div class="row">
                <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12">
                 ...
                 <p>{{ trans('admin.country') }}</p>
                  {{ Form::select('country_id', App\Country::pluck('name_' . lang(), 'id'), $mall->country_id, ['class'=>'form-control']) }}
                  </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    {{ Form::select('user_id', App\User::where('level', 'mall')->pluck('name', 'id'), $mall->user_id, ['class'=>'form-control']) }}
                  </div>
                </div>
              </div>
                      <div class="row">
