        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">{{ trans('admin.new_country') }}</h4>
            </div>
            <div class="card-body">
              {{ Form::open(['url' => url('/admin/countries/' . $country->id), 'files' => true, 'method' => 'put']) }}
                <div class="row">
                  <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">{{ trans('admin.mobile_code') }}</label>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">{{ trans('admin.country_code') }}</label>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">{{ trans('admin.currency') }}</label>
