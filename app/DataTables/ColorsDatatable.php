...
class ColorsDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ->eloquent($query)
            ->addColumn('check', $path . '.colors.btn.check_box')
            ->addColumn('edit', $path . '.colors.btn.edit')
            ->addColumn('delete', $path . '.colors.btn.delete')
            ->addColumn('color', $path . '.colors.btn.color')
            ->rawColumns([
                'check',
                'edit',
                'delete',
    ...
    {
        return Color::query()->when(isManager(), function($query){
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('color')->title(trans('admin.color'))->data('color'),
