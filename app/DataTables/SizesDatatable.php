...
class SizesDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ->eloquent($query)
            ->addColumn('check', $path . '.sizes.btn.check_box')
            ->addColumn('edit', $path . '.sizes.btn.edit')
            ->addColumn('delete', $path . '.sizes.btn.delete')
            ->rawColumns([
                'check',
                'edit',
                'delete'
    ...
    {
        return Size::query()->with('department')->when(isManager(), function($query){
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('is_public')->title(trans('admin.is_public'))->data('is_public'),
            Column::make('department')->title(trans('admin.department'))->data('department.name_' . lang()),
