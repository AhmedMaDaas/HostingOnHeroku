...
class StatesDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('check', 'admin.states.btn.check_box')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('country_id')->title(trans('admin.country_id'))->data('country.name_' . lang()),
            Column::make('city_id')->title(trans('admin.city_id'))->data('city.name_' . lang()),
