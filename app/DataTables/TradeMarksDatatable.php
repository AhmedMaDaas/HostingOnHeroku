...
class TradeMArksDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ->eloquent($query)
            ->addColumn('check', $path . '.tradeMarks.btn.check_box')
            ->addColumn('edit', $path . '.tradeMarks.btn.edit')
            ->addColumn('delete', $path . '.tradeMarks.btn.delete')
            ->rawColumns([
                'check',
                'edit',
                'delete'
    ...
    {
        return TradeMark::query()->when(isManager(), function($query){
