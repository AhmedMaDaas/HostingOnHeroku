...
class ManufacturersDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ->eloquent($query)
            ->addColumn('check', $path . '.manufacturers.btn.check_box')
            ->addColumn('edit', $path . '.manufacturers.btn.edit')
            ->addColumn('delete', $path . '.manufacturers.btn.delete')
            ->rawColumns([
                'check',
                'edit',
                'delete'
    ...
    {
        return Manufacturer::query()->when(isManager(), function($query){
